        ...
        {mode === 'buy' && (
          <div className="stock-market-section">
            <div className="stock-market-form-group">
              <label htmlFor="buy-stock">Choose Stock:</label>
              <select
                id="buy-stock"
              ...
              >
                ...
                {stocks.map(stock => (
                  <option key={stock.id} value={stock.id}>
                    {stock.ticker} - {stock.name} ({formatPLN(stock.price)})
                  </option>
                ))}
              </select>
            </div>
              ...
              <>
                ...
                <div className="stock-market-details">
                  <div className="detail-row">
                    ...
                    <span className="detail-value">{formatPLN(selectedStock.price)}</span>
                  </div>
                  <div className="detail-row">
                    <span>Quantity:</span>
                  ...
                  <div className="detail-row total">
                    ...
                    <span className="detail-value">{formatPLN(totalPrice)}</span>
                  </div>
                  <div className="detail-row">
                    <span>Your Money:</span>
                    <span className={`detail-value ${totalPrice > currentPlayer.money ? 'insufficient' : ''}`}>
                      {formatPLN(currentPlayer.money)}
                    </span>
                  </div>
                </div>
        ...
        {mode === 'sell' && (
          <div className="stock-market-section">
            {ownedStocks.length === 0 ? (
              ...
              <>
                <div className="stock-market-form-group">
                  <label htmlFor="sell-stock">Choose Stock to Sell:</label>
                  <select
                    id="sell-stock"
                    value={selectedStockId || ''}
                    onChange={e => {
                  ...
                  >
                    ...
                    {ownedStocks.map(stock => (
                      <option key={stock.id} value={stock.id}>
                        {stock.ticker} - {stock.name} (Own: {stock.ownedQuantity})
                      </option>
                    ))}
                  </select>
                </div>
                  ...
                  <>
                    ...
                    <div className="stock-market-details">
                      ...
                      <div className="detail-row total">
                        ...
                        <span className="detail-value profit">{formatPLN(totalPrice)}</span>
                      </div>
                      <div className="detail-row">
                        <span>You own:</span>
